...
Shipworthy is an open-source Claude Code plugin that enforces production engineering practices across AI coding sessions. v1.3.0 with 57 skills, 6 hooks, 6 agents, 8 templates, 5 adapters, 3 presets, 7 commands.

## Repository Structure

```
skills/              56 engineering skills as SKILL.md files (YAML frontmatter + Markdown)
  ...
  operations/        13 skills: CI/CD, git worktrees, migrations, feature flags, incident response, context-manager
...
v1.3.0 — Context Intelligence (April 4, 2026)
