...
The user sees nothing. They just start talking.
...
All hooks are advisory — they warn but never block.
...
The user just said what they wanted. Everything else happened automatically.
...
| Shipworthy Skills | Engineering practices | Plugin (52 skills) |
