...
1. **Architecture compliance** — check all code against `.engineering-with-vibes/architecture.md` Mandatory Rules
...
5. **Tech debt review** — check `.engineering-with-vibes/tech-debt.md` for outstanding items
